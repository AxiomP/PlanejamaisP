  ...
  return (
    <ToastPrimitives.Root
      ...
      className={`
        ...
        overflow-hidden rounded-lg border-2 p-4 pr-8 shadow-lg transition-all
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={`
      ...
      hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-[#2C3E7D] focus:ring-offset-2
